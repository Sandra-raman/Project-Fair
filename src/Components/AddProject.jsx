  ...
  return (
    <div>
      <Button variant="primary" onClick={handleShow}>
        Upload
        <IoMdCloudUpload className=" fs-4 ms-2" />
      </Button>
              ...
              <label>
                ...
                <img
                  src={
                    Preview
                      ? Preview
                      : "https://png.pngtree.com/png-clipart/20231016/original/pngtree-professional-web-developer-3d-illustration-png-image_13322705.png"
                  }
                  alt=""
                  height={"350px"}
                  width={"350px"}
